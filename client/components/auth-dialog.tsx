...
export function AuthDialog({ open, onOpenChange, onSuccess }: AuthDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md bg-zinc-950 text-white border-zinc-800 shadow-2xl">
        <DialogHeader className="space-y-1">
          <div className="flex items-center gap-2 text-blue-400 font-semibold text-sm">
            <Sparkles className="w-4 h-4" /> NotebookLM Workspace
          </div>
          <DialogTitle className="text-2xl font-bold tracking-tight">
            {tab === "signin" ? "Sign in to your workspace" : "Create an account"}
          </DialogTitle>
          <DialogDescription className="text-zinc-400">
            Access your research, sources, and AI-synthesized notebooks.
          </DialogDescription>
        </DialogHeader>
        ...
        <Button
          ...
          className="w-full bg-zinc-900 hover:bg-zinc-800 border-zinc-800 text-zinc-200"
        >
